...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('author', 'comment'), name='unique_user_comment_like')],
            },
        ),
        migrations.CreateModel(
            name='PostLike',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('author', 'post'), name='unique_user_post_like')],
            },
        ),
    ]
